...
from api.views.student.student_forum.student_question.student_viewquestion import StudentViewQuestionView
...
urlpatterns = [
    ...
    path('student/student_forum/student_question/student_viewquestion/', StudentViewQuestionView.as_view(), name='student_viewquestion'),
