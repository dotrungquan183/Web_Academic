...
function AdminTagsForumQuestion() {
    ...
    const fetchQuestions = useCallback(async () => {
        try {
            ...
            const response = await fetch(
                `http://localhost:8000/api/admin/admin_forum/admin_tag/admin_showquestion_tags/${tagId}?${params.toString()}`
            );
            ...
            <div style={containerStyle}>
                <div style={headerStyle}>
                    ...
                    <button
                        ...
                        onClick={() => navigate("/adminforum/question/askquestion")}
                    >
                        Đặt câu hỏi
                    </button>
                </div>
...
export default AdminTagsForumQuestion;
