...
function Login({ onLoginSuccess }) {
  ...
  // Hàm xử lý khi nhấn nút Đăng nhập hoặc "Enter"
  const handleLogin = async (e) => {
    e.preventDefault(); // Ngừng sự kiện mặc định của form (nếu có)
    try {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100vh" }}>
      ...
      >
        ...
        <form onSubmit={handleLogin} autoComplete="off"> {/* Thêm autoComplete="off" */}
          ...
          <button
            type="submit"  // Gọi handleLogin khi nhấn nút Đăng nhập hoặc Enter
            style={{
              width: "100%",
              padding: "10px",
