...
function Sidebar() {
  ...
  const isForumTab = location.pathname.startsWith("/studentprofile/forum");
  const isCoursesTab = location.pathname.startsWith("/studentprofile/courses");

  return (
    <div style={styles.sidebar}>
      <Link to="/studentprofile/forum" style={styles.link}>
        <button
          style={{
            ...styles.button,
      ...
      <Link to="/studentprofile/courses" style={styles.link}>
        <button
          style={{
            ...styles.button,
